        ...
        <div class="reg-inp">            
          <form class="Register">
            ...
            <label>Child's Photo</label><br />
              ...
              <asp:Button ID="Button1" runat="server" Text="Upload" onclick="Button1_Click" type="button" class="btn btn-secondary btn-lg"/><br />
              <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><br />
              <asp:Button ID="Button2" runat="server" Text="Register" OnClick="Button2_Click" class="btn btn-secondary btn-lg" type="submit"/><br />
          </form>  
        </div>
        <div class="gap">
          <!--<h1></h1>-->
